...
class Request(
        ...
        val payload: String,
        val params: Map<String, String>, val args: Map<String, String>) {

    constructor(request: Request, params: Map<String, String>)
            : this(request.url, request.method, request.version, request.headers, request.payload, params, request.args)
}
